        ...
        <x-slot name="content">
            ...
            <ul>
                @forelse (Cart::content() as $item)
                   <li class="flex p-2 border-b border-gray-200">
                       <img class="h-15 w-20 object-cover mr-4" src="{{ Str::replaceArray('http://vyncolor.test', [''], $item->options->image) }}" alt="">
            ...
            @if (Cart::count())
                <div class="py-2 px-3">
                    ...
                    <x-button2-enlace href="{{route('shopping-cart')}}" color="yellow" class="w-full ">
